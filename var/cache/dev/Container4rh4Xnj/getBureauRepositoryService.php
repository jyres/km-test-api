 ...
 */
class getBureauRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BureauRepository' shared autowired service.
     *
     * @return \App\Repository\BureauRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BureauRepository.php';

        return $container->privates['App\\Repository\\BureauRepository'] = new \App\Repository\BureauRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), ($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)));
    }
}
