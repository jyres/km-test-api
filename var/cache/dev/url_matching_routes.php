...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/reservations' => [[['_route' => 'reservations', '_controller' => 'App\\Controller\\ApiController::store_new_reservation'], null, ['POST' => 0], null, false, false, null]],
        '/bureaux' => [[['_route' => 'get_all_bureaux', '_controller' => 'App\\Controller\\ApiController::get_all_bureaux'], null, ['GET' => 0], null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/api(?'
    ...
    [ // $dynamicRoutes
        ...
        332 => [
            [['_route' => 'user_reservations', '_controller' => 'App\\Controller\\ApiController::get_user_reservations'], ['id_user'], ['GET' => 0], null, false, false, null],
